    ...
    public static function form_item($args = array())
    {
        ...
        switch ($type)
        {
            ...
            foreach ($options as $option_key => $option_value)
            {
                ...
                $html.='<input type="radio" value= "'.$option_key.'" name="'.$name.'" id="'.$option_key.'"';
            ...
            case "file_upload":
                ...
                $html.='<input type="file" name="'.$name.'" id="'.$ID.'" '.$required.'>';
            break;
            ...
            default:
                ...
                if($width)
                {
                    $this_width='width='.$width.'px';
                }
                $html.='<label for="'.$ID.'">'.$label.'</label>';
                $html.='<input id="'.$ID.'" name="'.$name.'" value="'.$value.'" '.$this_width.' type="textbox" '.$required.'>';
            break;
